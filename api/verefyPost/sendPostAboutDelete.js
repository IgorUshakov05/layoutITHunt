...
async function deleteAccount({userPost,code,username}) {
    ...
    <div class="body">
        ...
        <h1>До новых встреч</h1>
        <p>Здравствуйте, ${username}</p>
        <p class="23">Мы понимаем, что удаление аккаунта - это серьезное решение, которое принимается не без веских причин. Всегда жаль прощаться с членом нашего сообщества. Надеемся, что ваш выбор был обдуманным и принятым в соответствии с вашими потребностями и обстоятельствами.</p>
        <p class="m10">Наша команда всегда стремится предоставить вам лучший опыт и решения, которые соответствуют вашим ожиданиям. Мы ценим вашу доверие и поддержку, которую вы оказывали нашему сервису.</p>
        <p class="m10">Помните, что мы всегда рады видеть вас снова в нашем сообществе. Если у вас возникнут вопросы или если вам потребуется помощь, не стесняйтесь обращаться к нам. Мы готовы помочь вам в любое время и решить любые возникающие проблемы.</p>
...
deleteAccount({userPost:'igorushakov111@gmail.com',code:'237194',username: "Игорь"})